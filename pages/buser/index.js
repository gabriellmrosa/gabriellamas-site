    ...
    <Container>
      ...
      <div className="body">
        ...
        <p>
          ...
          managed to understand what we really needed to solve, a summary of
          what we discovered:
        </p>
        <ul>
          ...
          <li>
            The BX squad did not have a way to make group refunds, at that time
            they only had the option to make one at a time and with limitations,
            it took a long time for repeated actions, there was no list just to
            view BX refunds
          </li>
          <li>
            It was not defined who created the incident in the system, sometimes
            someone from the BX squad created the risk, the Risk Squad wanted
            only them to create the incident because sometimes the BX created
            was filled in wrong, but to make a refund, thing that the BX squad
            needed, it could only be done with an incident created, that is, in
            this way, one squad was waiting for another to take an action, and
            when another took it, it was sometimes wrong, in short: we needed to
            decouple the action of making a refund for a passenger of the need
            to have an incident created but sometimes the refund was made on
            account of an incident, now what? how to solve this?
          </li>
          <li>
            ...
            system and almost filling in everything they had already filled out
            to generate a payment request for the company finance
          </li>
          <li>
            ...
            sharing the only way was to look in a listing, filter and then open
            it.
          </li>
          <li>
        ...
        <p>
          ...
          incidents and refunds, with their necessary actions, that is, what
          each squad should do in each of them, then all other problems would be
          solved in cascade, follow my reasoning:
        </p>
        <ul>
          <li>
            ...
            mechanic shop, calling passengers for help and charging the partner
            for sending documents and some incidents involved all of this at the
            same time. The interface oriented to the categories of
            refunds/incidents allowed any BX analyst who received a call to only
            worry about posting the refund needed for passengers, according to
            the category understood, and this generated a refund line, every
            refund line may or may not have an incident linked to which risk
            needs to act, with each category now detailed which squad should act
            or not, automatically, when necessary, the system itself notifies
            the risk squad of a new incident created, it just needs to validate
            and fill in, the BX clerk no longer has to wait for the risk caller
            to create an incident for him to make the refund, and the risk clerk
            can freely fill in the incident information, all without one
        ...
        <ul>
          <li>
            ...
            transpiled this in real UI screens to test the new flow, this
        ...
        <ul>
          <li>
            ...
            refunds to passengers without having to wait for any action from the
            risk squad.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            all the alerts of all the themes about all the trips running at this
            moment, very inspired by the airport screens, soon I'll bring it
            here.
          </li>
          <li>
          ...
          <li>
            ...
            adapt process, every bus need to update your radar and other
            equipments. flow link
          </li>
        </ul>
        <p>
          So, I created so many things that improve other parts and other parts
          of all intern system but a thing I brought the most important
        </p>
      </div>
    </Container>
  );
